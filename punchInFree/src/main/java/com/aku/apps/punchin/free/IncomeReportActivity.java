...
public class IncomeReportActivity extends GDActivity {
	...
	void extractIntentData() {
		...
		toDate = currentDate;
		reportColumns = IncomeReportGenerator.getAvailableColumns(this);
		
		selectedColumns = prefs.getIncomeReportColumns();
	...
	private class ExportDataAction extends AsyncTask<Void, String, Void> {
		...
		protected Void doInBackground(Void... args) {
			...
			Preferences prefs = datasourceFactory.createPreferences();
			prefs.setIncomeReportColumns(selectedColumns);
			datasourceFactory.createPreferenceFactory().update(prefs);
			
			ReportGenerator generator = new IncomeReportGenerator(fromDate, toDate);
