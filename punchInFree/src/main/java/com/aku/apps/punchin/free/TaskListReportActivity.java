...
public class TaskListReportActivity extends GDActivity {
	...
	void extractIntentData() {
		...
		reportColumns = TaskListReportGenerator.getAvailableColumns(this);
		
		selectedColumns = prefs.getTaskListReportColumns();
	...
	private class ExportDataAction extends AsyncTask<Void, String, Void> {
		...
		protected Void doInBackground(Void... args) {
			...
			Preferences prefs = datasourceFactory.createPreferences();
			prefs.setTaskListReportColumns(selectedColumns);
			datasourceFactory.createPreferenceFactory().update(prefs);
			
			ReportGenerator generator = new TaskListReportGenerator();
