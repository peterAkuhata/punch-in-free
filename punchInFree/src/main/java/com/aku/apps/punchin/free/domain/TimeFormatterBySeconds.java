...
/**
 * Represents a format of time that shows the hours, minutes and seconds.
 * This is the default time formatter.
 * @author Peter Akuhata
 *
 */
public class TimeFormatterBySeconds implements TimeFormatter {
	@Override
	...
	public String formatTime(Date startDate, Date endDate) {
		...
		long seconds = DateUtil.getSeconds(startDate, endDate);
	...
	public int getDescription() {
		return R.string.label_seconds_eg;
	}

	@Override
	public int getId() {
		return Constants.TimeFormatters.BY_SECONDS;
	}

	public TimeFormatterBySeconds() {
		super();
	}
