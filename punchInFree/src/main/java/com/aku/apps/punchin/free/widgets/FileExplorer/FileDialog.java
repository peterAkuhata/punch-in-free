package com.aku.apps.punchin.free.widgets.FileExplorer;
...
public class FileDialog extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout list = (LinearLayout)findViewById(R.id.fdLinearLayoutList);
	...
	public void selectFileAndClose() {
