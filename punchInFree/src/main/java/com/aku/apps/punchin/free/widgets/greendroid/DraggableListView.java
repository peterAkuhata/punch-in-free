...
public class DraggableListView extends ListView {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if ((dragging == null) || (dropListener == null)) {
        ...
        case MotionEvent.ACTION_CANCEL:
            ...
            if (dropListener != null) {
                if (draggingItemHoverPosition == END_OF_LIST_POSITION) {
                    dropListener.drop(dragStartPosition, getCount() - 1);
                } else if (draggingItemHoverPosition != getInvalidPosition()) {
                    dropListener.drop(dragStartPosition, draggingItemHoverPosition);
                }
            }
            resetViews();
            break;
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if (position != getInvalidPosition()) {
    ...
    private int mInvalidPosition = INVALID_POSITION;
    
	public int getInvalidPosition() {
		return mInvalidPosition;
	}
	
	public void setInvalidPosition(int pos) {
		this.mInvalidPosition = pos;
	}
